...
<body>
	...
	<div class="complaintscontainer">
		...
		<tbody>
		    ...
		    $query = "SELECT * from complaints WHERE (Status = 'Not seen' || Status = 'Approved' || Status = 'In Process') && Category = 'Disciplinary Matters' ORDER BY Reg_DateTime DESC";
		    ...
		    if($count>0)
		    {
		    	while($row = mysqli_fetch_array($res))
		    	{
                    ...
                    <td>
				        <form action="upd_disciplinary.php" method="POST" >
