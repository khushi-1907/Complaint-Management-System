...
<body>
	...
	<div class="complaintscontainer">
		...
		<tbody>
		    ...
		    $query = "SELECT * from complaints WHERE Category = 'Others' ORDER BY Reg_DateTime DESC";
		    ...
		    if($count>0)
		    {
		    	while($row = mysqli_fetch_array($res))
		    	{
                    ...
                    <td>
				        <form action="upd_others.php" method="POST" >
                        <label for="inputCategory">Select Status</label>
                        <select class="input-group flex-container" id="inputCategory" name="category">
