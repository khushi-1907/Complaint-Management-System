...
<body>
	...
	<div class="complaintscontainer">
		...
		<tbody>
		    ...
		    $query = "SELECT * from complaints WHERE (Status = 'Not seen' || Status = 'Approved' || Status = 'In Process') && Category = 'Hostel Related' ORDER BY Reg_DateTime DESC";
		    ...
		    if($count>0)
		    {
		    	while($row = mysqli_fetch_array($res))
		    	{
                    ...
                    <td>
				        <form action="upd_hostel.php" method="POST" >
		    ...
		    ?>
			<div>
			<a href="history/hist_hostel.php"><u>View complaint history</u></a>
			</div>
