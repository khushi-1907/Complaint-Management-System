...
<body>
	...
	<div class="complaintscontainer">
		...
		<tbody>
			...
			WHERE Category = 'Sexual Harassment or Misconduct'
		    ...
		    if($count>0)
		    {
		    	while($row = mysqli_fetch_array($res))
		    	{
                    ...
                    <td>
				        <form action="upd_misconduct.php" method="POST" >
		    ...
		    ?>
			<div>
			<a href="history/hist_misconduct.php"><u>View complaint history</u></a>
			</div>
